...
class ViewController: UIViewController {
    ...
    let messages: [String] = ["You're in luck!", "Try Again", "Maybe not...", "All signs point to yes.", "I'm not sure. You've stumped me.", "Sounds like a plan, my guy.", "You can bet on it."]
